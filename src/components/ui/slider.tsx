      ...
      <SliderPrimitive.Control className='data-vertical:min-h-40 relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:w-auto data-vertical:flex-col'>
        ...
        {Array.from({ length: _values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            key={index}
            className='border-border relative size-3 rounded-full border  bg-background transition-[color,box-shadow,transform] after:absolute after:-inset-2 hover:scale-105 focus-visible:ring-1 focus-visible:ring-ring/50 outline-none block shrink-0 select-none disabled:pointer-events-none disabled:opacity-50 shadow-sm'
          />
        ))}
