...
const ReduxToolkitLabContent: React.FC = () => {
  ...
  return (
    <div
      className='relative flex h-screen w-screen flex-col items-center justify-center overflow-hidden font-mono'
    ...
    >
      ...
      <div className='relative mb-24'>
        <div
          className='grid w-xs select-none touch-none gap-1 md:w-100 grid-cols-10'
